...
def update(content: str) -> str:
    ...
    return f"Document has been updated! Current content: \n{document_content}"
...
model = ChatGroq(model=MODEL_NAME, api_key=GROQ_API_KEY).bind_tools(tools)

def our_agent(state: AgentState) -> AgentState:
    
    system_promot = SystemMessage(content=f"""
    ...
    if not state["messages"]:
        user_input = "I'm ready to help you with a document. What would you like to create?"
